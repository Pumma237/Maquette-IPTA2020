...
<div class="row">
	<div class="col-lg-9">
		...
		<p>You can access the pdf version of the "Call for Papers" <a target="_blank" href="assets/pdf/callforpapers.pdf">here.</a></p>
		<object data="assets/pdf/callforpapers.pdf" type="application/pdf" width="100%" height="1250px">
		</object>
	</div>
	<div class="col-lg-3">
